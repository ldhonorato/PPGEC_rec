...
from processos.views import (
    ...
    matricula_oferta_planejamento_presencial_view,
    matricula_solicitar_view,
    matriculas_disciplinas_view,
    matriculas_minhas_view,
...
urlpatterns = [
    ...
    path("assinaturas/", solicitacoes_assinatura_view, name="solicitacoes_assinatura"),
    path("assinaturas/nova/", nova_solicitacao_assinatura_view, name="nova_solicitacao_assinatura"),
    path("assinaturas/pendentes/", pendencias_assinatura_view, name="pendencias_assinatura"),
    ...
    path(
        "gestao/matriculas/ofertas/<int:oferta_id>/planejamento-presencial/",
        matricula_oferta_planejamento_presencial_view,
        name="matricula_oferta_planejamento_presencial",
    ),
